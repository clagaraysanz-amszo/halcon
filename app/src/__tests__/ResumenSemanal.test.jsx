...
vi.mock('../hooks/useSupervisorWeekly', () => ({
  useSupervisorWeekly: () => ({
    ...
    data: {
      ...
      totales: { vuelos: 5, minutos: 120, asignados: 6, realizados: 5, tasa: 83 },
      porDia: [
        { fecha: '2026-08-10', label: 'Lun', vuelos: 2, minutos: 40, asignados: 2, realizados: 2 },
        { fecha: '2026-08-11', label: 'Mar', vuelos: 3, minutos: 80, asignados: 4, realizados: 3 },
        { fecha: '2026-08-12', label: 'Mié', vuelos: 0, minutos: 0, asignados: 0, realizados: 0 },
        { fecha: '2026-08-13', label: 'Jue', vuelos: 0, minutos: 0, asignados: 0, realizados: 0 },
        { fecha: '2026-08-14', label: 'Vie', vuelos: 0, minutos: 0, asignados: 0, realizados: 0 },
        { fecha: '2026-08-15', label: 'Sáb', vuelos: 0, minutos: 0, asignados: 0, realizados: 0 },
        { fecha: '2026-08-16', label: 'Dom', vuelos: 0, minutos: 0, asignados: 0, realizados: 0 },
      ],
      porTurno: {
        A: { vuelos: 3, minutos: 80, asignados: 4, realizados: 3 },
        B: { vuelos: 2, minutos: 40, asignados: 2, realizados: 2 },
        N: { vuelos: 0, minutos: 0, asignados: 0, realizados: 0 },
      },
      porOperador: [
        {
          halconN: '1',
